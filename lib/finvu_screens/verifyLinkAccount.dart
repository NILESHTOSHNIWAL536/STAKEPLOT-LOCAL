...
class VerifyLinkAccount extends StatefulWidget 
{
   ...
   VerifyLinkAccount({ Key? key ,required this.linkingReference}) : super(key: key);
                       ...
                       Padding(
                            ...
                            child: ElevatedButton(
                              onPressed: ()async{
                                  ...
                                  var  data = await finvuManager.confirmAccountLinking(widget.linkingReference,_controller.text);
