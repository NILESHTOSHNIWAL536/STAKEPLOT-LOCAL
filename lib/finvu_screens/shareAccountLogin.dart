      ...
      body: SafeArea(
        child: Container(
          ...
          padding: const EdgeInsets.symmetric(
              horizontal: 20, vertical: AppSizes.p20),
          child: Column(
            ...
            children: [
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: Container(
                          padding: const EdgeInsets.symmetric(
                              horizontal: 10.0, vertical: AppSizes.p2),
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: FontManager().getTextStyle(context,
                                    fontSize: 16.0, lWeight: FontWeight.bold),
                              ),
                            ],
                          ),
                        ),
              ...
              Padding(
                ...
                child: AvatarProfileImage(
                    url: Sign.transform, width: 4, height: 4),
              ),
            ...
            children: [
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Padding(
                              padding:
                                  const EdgeInsets.only(left: AppSizes.p10),
                              child: Text(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        FinvuStrings()
                            .whatAreAccountAggregators, // Direct access
                        style: FontManager().getTextStyle(context,
                      ...
                      Text(
                        FinvuStrings()
                            .accountAggregatorsDescription, // Direct access
                        style: FontManager().getTextStyle(context,
              ...
              Container(
                ...
                child: Row(
                  children: [
                    AvatarProfileImage(
                        url: Sign.protection, width: 40, height: 40),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(
...
Widget getspinner(context,
    [str = "", color = AppColors.primaryColor, textColor = AppColors.bg5]) {
  return Container(
    width: MediaQuery.of(context).size.width / 1.1,
