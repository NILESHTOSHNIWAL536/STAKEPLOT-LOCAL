...
class UserProfileHeader extends StatefulWidget {
  ...
  bool flag;
  bool isBack;
   UserProfileHeader({ Key? key,required this.name,this.flag=true,this.isBack=true }) : super(key: key);
                    ...
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                       children: [
                              ...
                              InkWell(
                               ...
                               child: Icon(Icons.arrow_back_sharp,color:widget.isBack? Colorcodes.white:Colors.transparent,)
                              ),
                                  ...
                                  [
                                        GestureDetector(
                                         ...
                                         GestureDetector(
                                            ...
                                            widget.flag? Navigator.pushNamed(context, "/Profile"):null;
                                            },
                                           child: CircleAvatar(
                                            backgroundColor:Colorcodes.budgetLightGreen ,
                                            child: Center(child: ProfileImage(url: widget.flag? avatar.value:svgIconPath.money))
                                           ),
                                         )       
                                  ]
                            ),
