...
//   const VerifyOtpScreen({Key? key, required this.email, required this.selectedReason})
//       : super(key: key);
...
//   String? _generatedOtp; // For simulation; replace with backend logic
...
//     _generatedOtp = '123456'; // Simulated OTP; replace with actual OTP from backend
//     setState(() {
//       _isOtpSent = true;
//       _isLoading = false;
//     });
...
//     // await ApiConnect.sendOtp(widget.email);
//   }
...
//     await Future.delayed(Duration(seconds: 1));
//     return enteredOtp == _generatedOtp; // Simulated verification
//     // Actual API call example:
//     // return await ApiConnect.verifyOtp(widget.email, enteredOtp);
//   }
...
//                               _isLoading = true;
//                             });
//                             bool isVerified = await _verifyOtp(value);
//                             setState(() {
