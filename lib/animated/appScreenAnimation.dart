...
//     // final jerkCurve = Cubic(0.8, 0.0, 0.9, 0.1);
...
//       _controller.forward();
//       await Future.delayed(const Duration(milliseconds: 800)); // Shorter display duration
//       _controller.reset();
//       setState(() {
...
//             CurvedAnimation(
//               parent: _controller,
//               curve: const Interval(0.0, 0.5, curve: Curves.easeIn), // Quick fade-in
//             ),
//           ),
//           child: SlideTransition(
//             position: _slideAnimations[_currentIndex],
...
class _AppScreenAnimationState extends State<AppScreenAnimation>
  ...
  void _startAnimation() async {
    // Total duration for all animations to match Lottie splash (2000ms)
    const totalDuration = 4000;
    const animationCount = 7; // Number of SVGs
    const singleAnimationDuration = totalDuration ~/ animationCount; // ~285ms per SVG
