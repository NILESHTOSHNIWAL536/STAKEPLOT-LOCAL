            ...
            // );
              ...
              child: Container(
                ...
                child: Column(
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          child: Row(
                            children: [
                              AvatarProfileImage(url:dataObj["author"]['avatar'] ,width: 10,height: 13,),
                              const SizedBox(
                                width: 10,
                              ),
                  ...
                  // ),
                  (dataObj['isPoll'] ?? false)?getQuestionsAndOptions(dataObj['pollData'],context,true,dataObj['_id']) :Container(child:!dataObj['isItenary']?text(dataObj):dataObj['chartType']=="bargraph"?barGraph(dataObj):pieChart(dataObj)),
...
Widget barGraph(item)
{
    ...
    list.forEach((element) {
            ...
            String b=t2==""?"0":t2;
           chartData.add(SalesData(t1,double.parse(b),color[j]),);   
           j++;
    },);
                  ...
                  children: [
                         ...
                         Column(
                          ...
                          children:optionsList.map((op){
                            ...
                            String cal= len!=0 ? ((ll.length/len)* 100).toStringAsFixed(0):'0';
                         ...
                         return Obx(() =>   Padding(
                            ...
                            child: InkWell(
                              ...
                              child: Container(
                                  ...
                                  width:  MediaQuery.of(context).size.width/1.4,
                                 decoration: BoxDecoration(
                                     color:  op['option']==s?null:Colorcodes.white,
                                      borderRadius: BorderRadius.circular(Colorcodes.borderRadius),
                                       gradient:op['option']==s? LinearGradient(
                                        begin: Alignment.centerLeft,
                                        end: Alignment.centerRight,
                                        colors: [
                                          Colorcodes.poll1,
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        style: FontManager().getTextStyle(context,
                                                lWeight: FontWeight.bold,
                                                fontSize: 14,
                                                color: isSe?Colorcodes.white: Colors.black
                                              )),
                                      ),
                                   myvote.value ?  Text(cal=="0.00"?'0%':cal=="100.00"?"100%":cal+"%",
                                      style: FontManager().getTextStyle(context,
                                              lWeight: FontWeight.bold,
                                              fontSize: 14,
                                              color: isSe?Colorcodes.white: Colors.black
