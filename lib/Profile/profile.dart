...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:Obx(() =>  Column(
        children: [
           UserProfileHeader(name: userName.value,flag: false,),
          Expanded(
            child: Padding(
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child:Obx(() =>   Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            TextFeildWidget2(heading: "User Name", lableText: userName.value),
                            TextFeildWidget2(heading: "Email", lableText: email.value),
                            TextFeildWidget2(heading: "Phone Number", lableText: Phone.value),
                            TextFeildWidget2(heading: "Currency", lableText: currency.value),
  ...
  Widget aboutUs(){
    return Card(
                      ...
                      child: Padding(
                        ...
                        Obx(() =>  aboutMe.value  ?  InputDate("Tell about yourself",
                                  TextInputType.emailAddress, emailController):Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child:Obx(()=> Text((aboutUS.value.isEmpty ? "Loading....":aboutUS.value),
                                      style: FontManager().getTextStyle(context,
             ...
             children: [
                 Obx(() => Column(
                     children: [
                            ...
                            textStyle( doubleToFixed(income.value.toString()),Colorcodes.blue,18),
                     ],
                  )),
                Obx(() =>   Column(
                     children: [
                            textStyle("Expense",Colorcodes.black,18),
                            textStyle( doubleToFixed(expenses.value),Colorcodes.red,18),
                     ],
                  )),
                Obx(() =>   Column(
                     children: [
                            textStyle("Score",Colorcodes.black,18),
                            textStyleDesign(doubleToFixed(score.value),Colorcodes.dropdown,18,context),
                     ],
                  )),
             ],
        ),
            ...
            flex: 1,
             child: Container(
              ...
              padding: EdgeInsets.symmetric(horizontal: 10,vertical: 4),
               child: Text(value,style:  FontManager().getTextStyle(context,
                  lWeight: FontWeight.w400,
                          fontSize: 13,
                          color: Colors.black
               ),),
...
Widget myDis(){
 ...
 return Column(
   ...
   children: [
    Padding(
      padding: const EdgeInsets.symmetric(horizontal: 20.0,vertical: 10),
      child: Text("My Discussion ",style: FontManager().getTextStyle(context,
                                                     lWeight: FontWeight.w500,
                                                     fontSize: 20,
                                                     color: Colors.black)),
    ),
        ...
        children: [
          Container(
                child: Wrap(
                        ...
                        children: myPostList.map((item) => PostCard(data: item)
                        ).toList(),
                ),
          ),
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              dataObj['image']!=null?Container(
                  width: MediaQuery.of(context).size.width / 1.1,
                  height: MediaQuery.of(context).size.height/3,
                  child: Image.network(dataObj['image']['filePath'], fit:  BoxFit.contain,filterQuality: FilterQuality.high, ),
