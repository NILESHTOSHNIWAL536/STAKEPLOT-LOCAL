...
class _BankscardssliderState extends State<Bankscardsslider> {
 ...
 String _displayMaskedAccount(BankAccountModel data) {
  ...
  String _displayLastFetchDate(String lastFetch) {
    ...
    final parsedDate = DateTime.tryParse(lastFetch);
    if (parsedDate == null) return lastFetch;

    return formatWhatsAppDate(parsedDate);
  }
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: AppSizes.h10),
                  Text(
                    "Bal as of ${_displayLastFetchDate(data.lastFetch)}",
                    overflow: TextOverflow.ellipsis,
                    style: FontManager().getTextStyle(
                      context,
                      fontSize: 12,
