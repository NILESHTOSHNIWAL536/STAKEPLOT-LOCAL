...
//           double similarity = _calculateSimilarity(word, sub);
...
//           double similarity = _calculateSimilarity(word, cat);
//           if (similarity >= 80 && similarity > maxSimilarity) {
//             maxSimilarity = similarity;
//             spokenCategory = cat;
...
//           double similarity = _calculateSimilarity(word, name);
//           if (similarity >= 80 && similarity > maxSimilarity) {
//             maxSimilarity = similarity;
//             spokenCategory = name;
//             spokenSubCategory = '';
...
//   bool get isListening2 => isListening;

//   Animation<double> get micAnimation2 => micAnimation;
