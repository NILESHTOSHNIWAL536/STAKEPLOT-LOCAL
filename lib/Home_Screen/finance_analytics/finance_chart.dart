...
class _SpendingCardTwoPanelsState extends State<SpendingCardTwoPanels> {
  ...
  int selectedIndex = 6;
  final double chartMaxHeight = 160.0;
  ...
  Widget build(BuildContext context) {
    ...
    final Color greyColor = Color(0xFFB7B8C7);

    // Compute series width & spacing so 7 bars fit into rightVisible:
    // We'll use tight values: large width fraction, zero spacing.
    // If you want to fine-tune, change these values.
    final double seriesWidthFraction = 0.9; // thick bars
    final double spacingFraction = 0.2; // no gap
          ...
          children: [
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('Credited',  style: FontManager().getTextStyle(context,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Text('Debited',  style: FontManager().getTextStyle(context,
                                lWeight: FontWeight.w400,
                                fontSize: 12,
                                color: AppColors.debitedAmount)),
                      ],
            ...
            Container(
              ...
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  // Chart area - no horizontal scroll now
                  SizedBox(
                    height: chartMaxHeight + 30,
                    width: rightVisible, 
                    child: SizedBox(
                      width: rightVisible,
                      child: SfCartesianChart(
                        ...
                        onSelectionChanged: (SelectionArgs args) {
                          final int idx = (args.pointIndex ?? 0).clamp(0, max(0, data.length - 1));
                          setState(() => selectedIndex = idx);
                        },
    
                       primaryXAxis: CategoryAxis(
      // ensure each category is shown and label doesn't get clipped at edges
      interval: 1,
      maximumLabels: 7,
      edgeLabelPlacement: EdgeLabelPlacement.shift,
      labelIntersectAction: AxisLabelIntersectAction.rotate45, // or .wrap / .hide as you prefer
      labelRotation: 0, // use 0 or 45 when rotating
      majorGridLines: const MajorGridLines(width: 0),
      axisLine: const AxisLine(width: 0),
      majorTickLines: const MajorTickLines(size: 0),
      labelStyle:   FontManager().getTextStyle(context,
      ...
      labelAlignment: LabelAlignment.center,
                        ...
                        series: <ChartSeries>[
                          ...
                          StackedColumnSeries<ChartData, String>(
                            ...
                            pointColorMapper: (d, idx) =>
                                idx == selectedIndex ? debitColor.withOpacity(0.95) : greyColor,
                            spacing: spacingFraction,
                            width: seriesWidthFraction,
    ...
    bottomRight: Radius.circular(3),
                          ...
                          StackedColumnSeries<ChartData, String>(
                            ...
                            pointColorMapper: (d, idx) =>
                                idx == selectedIndex ? creditColor : greyColor,
                            spacing: spacingFraction,
                            width: seriesWidthFraction,
                            selectionBehavior: SelectionBehavior(enable: true),
                           borderRadius: const BorderRadius.only(
