...
RxBool showCheckBox = false.obs; // Initialize as false to avoid showing checkboxes by default
          ...
          child: Row(
            children: [
                ...
                child: showCheckBox.value
                    ? Container(
                        ...
                        child: Checkbox(
                          ...
                          semanticLabel: 'Select transaction ${transaction['_id']}',
                        ),
                      )
              ...
              Container(
                ...
                padding: EdgeInsets.only(top: padding/6, bottom: padding/6),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    (isManual || isReview)
                        ? reviewTagTransactions(isReview, scaleFactor, isManual, margin, badgeSize, fontSizeSmall, context, index, id)
...
Widget reviewTagTransactions(bool isReview, double scaleFactor, bool isManual, double margin, double badgeSize, double fontSizeSmall, BuildContext context, int index, String narration_id) {
  return Row(
        ...
        Row(
          ...
          children: [
            Container(
             ...
             SizedBox(width: 8 * scaleFactor), // Space between review badge and logo
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: textStyleOnly2(
                                          context: context,
                                          text: "Do you want to hide this transaction?",
...
Widget getTagButton(Map<String, dynamic> transaction, int index, String category, BuildContext context, String narration_id) {
  return Row(
    mainAxisAlignment: MainAxisAlignment.spaceBetween,
    children: [
      InkWell(
...
void callTagModal(BuildContext context, Map<String, dynamic> transaction, int index, String category) {
  tagName.value = category;
  showModalBottomSheet(
    context: context,
    isScrollControlled: true,
