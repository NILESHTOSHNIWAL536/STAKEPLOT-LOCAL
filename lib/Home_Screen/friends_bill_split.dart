...
//                               "NewFriendsUi: Split mode - Opening AmountEntryModal with totalAmount: ${widget.totalAmount}");
//                           Navigator.pop(context);
//                           final amounts = await showAmountEntryModal(context,widget.category.toString(),widget.subcategory.toString() );
//                           if (amounts != null) {
//                             print(
//                                 "NewFriendsUi: Split mode - Received amounts: $amounts");
//                             Navigator.pop(
...
//                     splitUserAmount(context, amounts.toString(), addedMembers, "categories",
//                         "subCategories");
//                     print("AmountEntryModal: Confirming amounts: $amounts");
//                     Navigator.pop(context, amounts);
//                   },
