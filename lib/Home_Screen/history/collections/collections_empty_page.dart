...
class CollectionDetailsPage extends StatelessWidget {
 ...
 final bool hasTransactions;
  const CollectionDetailsPage({super.key, required this.title, required this.hasTransactions});
              ...
              child: Row(
                children: [
                  _iconButton(HomePageIcons.filterOn),
                        ...
                        VerticalDashDivider( height: 30, color: AppColors.border, dashGap: 0,),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                AvatarProfileImage(url: HomePageIcons.noTransactionsInCollection, width: 3, height: 6.5),
                AvatarProfileImage(url: HomePageIcons.noTransactionsInCollection, width: 3, height: 6.5)
