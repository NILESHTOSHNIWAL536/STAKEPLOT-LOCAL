...
// class DateSummaryView extends StatefulWidget {
//   final RxList<Map<String, dynamic>> dayWiseTransactions;
//   final VoidCallback onBack;
...
//   @override
//   State<DateSummaryView> createState() => _DateSummaryViewState();
// }

// class _DateSummaryViewState extends State<DateSummaryView> {
//   String? selectedDate;
...
//             itemCount: widget.dayWiseTransactions.length,
//             itemBuilder: (context, index) {
//               final dateData = widget.dayWiseTransactions[index];
//               final date = convertStringToDateTime(dateData['date']);
//               final day = DateFormat('dd').format(date);
//               final dayName = DateFormat('EEE').format(date).toUpperCase();
//               final transactionCount = dateData['transactionCount'] ?? 25; // Replace with actual count if available

//               bool isSelected = selectedDate == dateData['date'];
...
//                   decoration: BoxDecoration(
//                     color: isSelected ? AppColors.finSpaceColor : AppColors.bg5,
//                     borderRadius: BorderRadius.circular(8),
...
//                     children: [
//                       Text(day, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: isSelected ? AppColors.backgroundColor : AppColors.accentColor)),
//                       Text(dayName, style: TextStyle(fontSize: 12, color: isSelected ? AppColors.backgroundColor : AppColors.accentColor)),
//                       Text('$transactionCount txns', style: TextStyle(fontSize: 12, color: isSelected ? AppColors.backgroundColor : AppColors.accentColor)),
//                     ],
//                   ),
//                 ),
//               );
...
//               ? Center(child: Text('Select a date to view transactions'))
//               : FutureBuilder<List<Map<String, dynamic>>>(
//                   future: getDayWiseTransactionsForDate(context, selectedDate!),
//                   builder: (context, snapshot) {
//                     if (snapshot.connectionState == ConnectionState.waiting) {
//                       return const Center(child: CircularProgressIndicator());
//                     }
...
//                     }
//                     final transactions = snapshot.data!;
//                     final dateData = widget.dayWiseTransactions.firstWhere((data) => data['date'] == selectedDate);
//                     final creditAmount = dateData['creditAmount'] ?? 0;
//                     final debitAmount = dateData['debitAmount'] ?? 0;
...
//                             mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                             children: [
//                               Text('Credit: ${formatAmount(creditAmount)}', style: TextStyle(fontSize: 16, color: AppColors.accentColor)),
//                               Text('Debit: ${formatAmount(debitAmount)}', style: TextStyle(fontSize: 16, color: AppColors.accentColor)),
//                             ],
//                           ),
//                         ),
//                         // Transaction List
