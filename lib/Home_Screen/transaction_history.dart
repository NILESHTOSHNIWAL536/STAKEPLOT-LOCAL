                  ...
                  child: Container(
                    ...
                    child: historyTransactions(
                      ...
                      transaction['transactionTimestamp']
                          ?.toString(), // Ensure this is a String or null
                    ),
                  ),
                ),
              ),
...
//         widget.isflag!
//             ? "${url}/transactionauto/getTransactions/2?page=$pageKey&limit=$_pageSize"
//             : "${url}/transactionauto/getTransactions/1?page=$pageKey&limit=$_pageSize"
//       );

//       if (response.statusCode == 200) {
//         var his = jsonDecode(response.body);
//         var obj = his['data'] as List<dynamic>?;

//         if (obj != null) {
//           List<Map<String, dynamic>> newItems = obj.cast<Map<String, dynamic>>();
          
//           if (widget.isflag!) {
//             if (widget.isYearView!) {
//               newItems = newItems.where((ele) => 
//                 isCurrentYear(ele['transactionTimestamp']?.toString() ?? '', selectedYear.value)
//               ).toList();
//             } else {
//               newItems = newItems.where((ele) => 
//                 isCurrentMonth(ele['transactionTimestamp']?.toString() ?? '', selectedMonth.value)
//               ).toList();
//             }
//           }
//           return newItems;
