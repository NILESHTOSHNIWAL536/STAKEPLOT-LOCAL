                                                     ...
                                                     children: [
                                                             Stack(
                                                               ...
                                                               Padding(
                                                                ...
                                                                child:Center(child: AvatarProfileImage(url:element['avatar']?? userAvatar , width: 10, height: 18)),
                                                              ),
                                                             ...
                                                             Center(child: Text(element['name'],style: FontManager().getTextStyle(context,overflow: TextOverflow.fade)))
