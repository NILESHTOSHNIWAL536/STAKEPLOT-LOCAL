...
import 'package:flutter_application_code_stakeplot/backed_connections/apiConnect/clearstack.dart';
import 'package:flutter_application_code_stakeplot/backed_connections/apis_connect.dart';
import 'package:flutter_application_code_stakeplot/backed_connections/apiAutomations/curd.dart'; // Added import
import 'package:flutter_application_code_stakeplot/backed_connections/googlesignin/google.dart';
import 'package:flutter_application_code_stakeplot/colorcodes.dart';
import 'package:flutter_application_code_stakeplot/finance_screen/Budgets/Budget.dart';
import 'package:flutter_application_code_stakeplot/finvu_screens/shareAccountLogin.dart';
        ...
        children: [
          ...
          InkWell(
            onTap: () async {
              final SharedPreferences _pref = await SharedPreferences.getInstance();
              String token = "Bearer " +
                  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY3NWMwYWZiZmNiMTcxMDc2NWFiOGU5MCIsImlhdCI6MTc0MTc3NjU5MCwiZXhwIjoxNzQ2OTYwNTkwfQ.dm6hkBDE1xAY48hAOMLckjL0wXcCh54TpWf3wZXQ6Uc";
              _pref.setString("accessToken", token);
        ...
        child: InkWell(
          onTap: () async {
            ...
            if (emailController.text.isEmpty || passwordController.text.isEmpty) {
              snackBarCalledfail(context, "Please enter all fields"); // You might want to update this to use signinData validation messages
              return;
            }
