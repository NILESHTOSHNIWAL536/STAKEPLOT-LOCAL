...
//     return SizedBox(
//       height:
//           MediaQuery.of(context).size.height * 0.2, // Match budget card height
//       child: debts.isEmpty
//           ? Center(
//               child: globalText(
//                 context: context,
//                 text: "No debts available",
//                 fontsize: 16,
...
//                   child: SizedBox(
//                     width: MediaQuery.of(context).size.width *
//                         0.85, // Match budget card width
//                     child: debtCard(context, debt),
//                   ),
//                 );
//               },
//             ),
...
//   Widget debtCard(BuildContext context, Debt debt) {
//     return GestureDetector(
//       onTap: () {
...
//                   // Optionally add more debt details, e.g., due date if available
//                 ],
//               ),
//             ),
//           ),
...
//   Widget _buildSummaryCard(String title, RxList list, Color color) {
