              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: GridView.builder(
                    ...
                    itemCount: calculators.length,
                    itemBuilder: (context, index) {
                      print('Building item: ${calculators[index]['name']}');
                      Widget? screen;
                      try {
                        screen = calculators[index]['screen'];
                      } catch (e) {
                        print(
                            'Error instantiating screen for ${calculators[index]['name']}: $e');
                      }
                      return GestureDetector(
                        onTap: () {
                          print('Navigating to: ${calculators[index]['name']}');
                          if (screen != null) {
                            Navigator.push(
                              context,
                            ...
                            print(
                                'Error: Screen is null for ${calculators[index]['name']}');
                            Navigator.push(
                              context,
                              MaterialPageRoute(
