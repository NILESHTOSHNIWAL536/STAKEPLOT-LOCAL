...
// final GFBottomSheetController _controller = GFBottomSheetController();
  ...
  Widget build(BuildContext context) {
    ...
    appBar: AppBar(
      ...
      floatingActionButton:Obx(() => indexFlag.value==1? SizedBox.shrink():InkWell(
        onTap: (){
            //  PostData
          ...
          child: Column(
            ...
            children: [
              //  tribeHeader(context,"home"),
               ...
               AnimatedCrossFade(
                      secondChild:Obx(() =>  historyListData.length==0 && findData? Loader(): !findData && historyListData.length==0?
                          addFrd()
                      :Column(
                        children: [
                           Container(child:  Column(children:historyListData.map((dataObj) =>  PostCard(data:dataObj)).toList())),
                          SizedBox(height: 100,),
                        ],
                      )), 
                      firstChild:Obx(() =>  getTrendingData.length==0 && findTranding? Loader(): !findTranding && getTrendingData.length==0?Text("No Post yet"):Column(
                        children: [
                       ...
                       crossFadeState: indexFlag.value==1? CrossFadeState.showFirst:CrossFadeState.showSecond, 
                                           ...
                                           child: Container(
                                               padding: const EdgeInsets.symmetric(horizontal: 40,vertical: 8),
                                                ...
                                                //  color:indexFlag.value==value? Color.fromRGBO(249, 246, 238, 1):Colors.white,
                                                      borderRadius: BorderRadius.circular(10),
                                                      color: indexFlag.value==value? Colorcodes.budgetDarkGreen:Colorcodes.budgetLightGreen,
                                                      border: Border.all(
                                             ...
                                             child: Text((title),
                                                     style: FontManager().getTextStyle(context,
                                                       lWeight: FontWeight.w400,
                                                       fontSize: 20,
                                                       color:indexFlag.value==value? Colorcodes.white: Colors.black)),
                                           ),
             );
}
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  // ),
                   Container(child:!dataObj['isItenary']?text(dataObj):dataObj['chartType']=="bargraph"?barGraph(dataObj):pieChart(dataObj)),
      ...
      child: Container(
        ...
        child: Column(
          children: [
               ...
               dataComment(),
               dataComment(),
                InputDate("write comment..",TextInputType.number,calController1),
        ...
        children: [
          Container(
                child: Wrap(
                        ...
                        children: historyListData.map((item) => Padding(
                    ...
                    children: [
                      Container(
                        child: Row(
                          children: [
                            ...
                            //   color: Colors.black,
                            // ),
                            AvatarProfileImage(url:item["author"]['avatar'] ,width: 8,height: 11,),
                            // ProfileImage(),
                            SizedBox(
                              width: 10,
                            ),
                     ...
                     Readmore(str: item['title'].toString().toString(),),
                                    ...
                                    // ):SizedBox.shrink(),
                                         ...
                                         Container(
                                          child:!item['isItenary']?text(item):item['chartType']=="bargraph"?barGraph(item):pieChart(item)),
...
Widget pieChart(item){
    ...
    if(item['description']==null || item['description']['itemlist']==null)return SizedBox.shrink();
 ...
 Widget addFrd() {
    ...
    return Container(
          ...
          // color: Colorcodes.billBody,
           child: Center(child: Text(StringConstant.tribeText,  style: FontManager().getTextStyle(context,
                                            lWeight: FontWeight.bold,
                                            fontSize: 24,
                                            lineHeight: 1.3,
                                            color: Colorcodes.dropdown)))
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      child:  likedList.contains("liked"+dataObj["_id"])? upvoteLiked(context):upvoteLike(context),
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.symmetric(horizontal: 5.0),
                                    child: Text(reRender.value? postCount[dataObj['_id']]!<0? postCount[dataObj['_id']].toString():  (postCount[dataObj['_id']].toString()):(postCount[dataObj['_id']].toString()),
                                  ...
                                  Container(
                                    ...
                                    child: GestureDetector(
                                      onTap: (){
                                       ...
                                       child:  likedList.contains("disliked"+dataObj["_id"]) ?downvoteLiked(context):downvoteLike(context),
                                      // child: const Icon(
                                      //   Icons.arrow_drop_down_outlined,
                                      //   size: 35,
                                      //   color: Colors.black,
                                    ...
                                    child: Row(
                                      children: [
                                        Container(
                                          ...
                                          child:  SvgPicture.asset(svgIconPath.comment,color: Colorcodes.white,)
                                          // child: ProfileImage(url: "assets/images/comment.svg",)
                                          ),
                                          const SizedBox(width: 6,),
                                  Text(postCommentCount[idData].toString()=='null'?  dataObj["comments"].toString():postCommentCount[idData].toString(),style: FontManager().getTextStyle(context,
                                  // Text(dataObj["comments"].toString(),style: FontManager().getTextStyle(context,
                                                         lWeight: FontWeight.w400,
                                                         fontSize: 18,
                                                         color: Colorcodes.white)),
