...
class TribeUnique extends StatefulWidget {
  ...
  RxBool popBox;
  TribeUnique({Key? key, required this.id, required this.dataObj, required this.popBox})
      : super(key: key);
        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                Obx(() => !widget.popBox.value?PostCard(
                ...
                Obx(() => widget.popBox.value?uploadData(uniquePostDeatils):SizedBox.shrink()),
                SizedBox(
                  height: 100,
                ),
              ],
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      if (maskedName.value.trim().isEmpty) {
                                        ...
                                        upvote2(context, "Comment", data.sId!,
                                            data, historyListData, data, index);
                                        String l1 = "liked" + idData;
                                    ...
                                    child: likeIcon(
                                        context,
                                        likedList
                                            .contains("liked" + data.sId.toString())),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 2.0),
