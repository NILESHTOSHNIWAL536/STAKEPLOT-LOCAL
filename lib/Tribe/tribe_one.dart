  ...
  void  getInfo()async
{
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          InputComment(str, TextInputType.name, replyController,
              replyid,),
        ],
      ),
    );
      ...
      child: Container(
          ...
          child: Column(
            children: [
                    ...
                    margin: EdgeInsets.only(bottom: 10),
                     ...
                     child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                       children: [
                         Column(
                          children: indexArray.map((index) => dataComments(commentList[index],index)).toList(),
                        ),
                      replyid!=""?Padding(
             ...
             replyid==""?InputDate("write comment..", TextInputType.name, calController1,
                  widget.id):SizedBox.shrink(),
            ],
          )
  ...
  //  RxList<Comments> data=data.obs;
    ...
    return  Obx(() =>     Column(
        ...
        Container(
          ...
          child: Row(
              ...
              children: [
                ...
                //   color: Colors.black,
                // ),
                AvatarProfileImage(url: data.author!.avatar.toString(), width: 15, height: 20),
                const SizedBox(
                  width: 0,
                ),
                Container(
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: (){
                                        ...
                                        upvote2(context,"Comment",data.sId!,data,historyListData,data,index);
                                    ...
                                    //   color: Colors.black,
                                    // ),
                                    child: likedList.contains("liked"+data.sId.toString())?upvoteLiked(context,false):upvoteLike(context,false),
                                  ),
                              
                                 Padding(
                                  padding: const EdgeInsets.symmetric(horizontal: 5.0),
                                  child: Text( data.sId==null  ? '0':(reRender.value?postCount[data.sId]!<0? postCount[dataObj['_id']].toString(): (postCount[data.sId].toString()):(postCount[data.sId].toString())),
                                  ...
                                  GestureDetector(
                                      onTap: (){
                                           ...
                                           downvote2(context,"Comment",data.sId!,data,historyListData,index);
                                            String l1="liked"+idData;
                                                    bool liked= likedList.contains(l1);
                                    ...
                                    child: likedList.contains("disliked"+data.sId.toString())?downvoteLiked(context,false):downvoteLike(context,false),
                                    // child: const Icon(
     ...
     index+1==indexArray.length? SizedBox.shrink():Divider(
                    color: Colorcodes.budgetLightGreen,
  ...
  Widget InputDate(lableText, keyBoard,TextEditingController Textcontroller, String postId) {
      ...
      child: Container(
        ...
        child: Center(
          child: TextField(
            ...
            postCommentCount.putIfAbsent(postId, () => widget.dataObj["comments"] ?? 0);
  ...
  Widget InputComment(lableText, keyBoard,TextEditingController Textcontroller, String commentId) {
        ...
        child: Center(
          child: TextField(
            ...
            decoration: InputDecoration(
              filled: true,
              hintText: lableText,
              suffixIcon: suffix(Textcontroller.text, commentId, Textcontroller),
 ...
 Widget suffix(value, commentId, Textcontroller){
  return GestureDetector(
    ...
    child: Container(
                  height: 10,
                  width: 10,
                  child: AvatarProfileImage(url: svgIconPath.sendMsg,height: 10,width: 10,)
                ),
  );
 }
 Widget suffixcomment(TextEditingController Textcontroller,postId){
  ...
  Widget replyDatas(Replies replayObj,Comments data) {
    ...
    return Container(
      ...
      child: Row(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            AvatarProfileImage(url: replayObj.author!.avatar.toString(), width: 15, height: 20),
            const SizedBox(
              width: 0,
            ),
            Container(
               width:  width<=430?  MediaQuery.of(context).size.width/2: MediaQuery.of(context).size.width<=500?  width/1.8: MediaQuery.of(context).size.width/1.8,
              child: Column(
                mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
  ...
  void navigate(){
         Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (context) => TribeUnique( id:widget.id,dataObj: widget.dataObj,),
                      ),
                  );
  }
...
void upvote2(context,String str,String objectId,dataObj,historyListData2,Comments commentObj,int index)async{
    final SharedPreferences _pref = await SharedPreferences.getInstance();
     var  accessToken=_pref.getString("accessToken"); 
...
void downvote2(context,String str,String objectId,Comments dataObj,historyListData2,int index)async{
    final SharedPreferences _pref = await SharedPreferences.getInstance();
     var  accessToken=_pref.getString("accessToken");
...
Widget showModel(context,id,[flag=false]){
    return  Container(
           ...
           child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.center,
               children: [
                         Text("Report",style: FontManager().getTextStyle(context,
                                    fontSize: 20,
                                   lWeight: FontWeight.bold,
                         ),),
                        const SizedBox(height: 20,),
                        textStyleModel(context,"Helps us to understand the issue, and look into it.",id,flag), 
                        const SizedBox(height: 20,),
