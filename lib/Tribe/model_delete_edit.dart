...
void showEditBottomSheet2({
  required BuildContext context,
  required String initialText,
  required String id,
  required String postId,
  required String type,
  // required void Function(String updatedText) onUpdate,
}) {
  final TextEditingController controller = TextEditingController(text: initialText);
  // ValueNotifier<bool> isButtonEnabled = ValueNotifier(initialText.trim().isNotEmpty);
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              onChanged: (value)
              {
                 isButtonEnabled.value = controller.text == initialText;
              },
              decoration: InputDecoration(
                border: OutlineInputBorder(),
            ...
            Row(
              ...
              children: [
                ...
                const SizedBox(width: 10),
              Obx(()=>  InkWell(
                    onTap:  isButtonEnabled.value ?null:(){
                      // Your update logic here
                      editCommentReply(commentId: id, postId: postId, context: context, type: type, newText: controller.text);      
                    },
                    borderRadius: BorderRadius.circular(8),
                    child: Container(
                      padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                      decoration: BoxDecoration(
                        color: isButtonEnabled.value  ?Colors.grey: AppColors.primaryColor, // Use your theme color
                        borderRadius: BorderRadius.circular(8),
                      ),
                      child: const Text(
                        'Update',
