              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  contentPadding: const EdgeInsets.symmetric(
                      horizontal: AppSizes.p14, vertical: AppSizes.p14),
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12),
                    borderSide:
                        const BorderSide(color: Color(0xFF3B3F75), width: 2),
                  ),
                ),
              ),
                  ...
                  Obx(() => InkWell(
                        ...
                        child: Container(
                          padding: const EdgeInsets.symmetric(
                              horizontal: 20, vertical: AppSizes.p12),
                          decoration: BoxDecoration(
...
void showDeleteDialogComment(BuildContext context2, String commentText,
    String type, String id, String postId, int index, int replyindex) {
  showDialog(
      context: context2,
      ...
      builder: (ctx) => AlertDialog(
            ...
            contentPadding: const EdgeInsets.symmetric(
                vertical: AppSizes.p20, horizontal: 16),
            content: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                // Top Icon
                ...
                AvatarProfileImage(
                    url: 'assets/svgs/delete_pop.svg', width: 10, height: 12),
                ...
                Text(
                  ...
                  style: FontManager().getTextStyle(context2,
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        padding: const EdgeInsets.symmetric(
                            horizontal: 24, vertical: AppSizes.p12),
