...
class TribeShare extends StatefulWidget {
  var data;
  var dataObj;
   TribeShare({Key? key,required this.data,required this.dataObj}) : super(key: key);
          ...
          InkWell(
            ...
            child: Container(
              ...
              //    ):SizedBox.shrink(),
                   ...
                   Container(
                                          child:!dataObj['isItenary']?text(dataObj):dataObj['chartType']=="bargraph"?barGraph(dataObj):pieChart(dataObj)),
                          ...
                          children: [
                            InkWell(
                              ...
                              child: Container( 
                                ...
                                decoration: BoxDecoration(
                                color: addedUser.isEmpty?  Colorcodes.billBody:Colorcodes.dropdown,
                                           ...
                                           GestureDetector(
                                            onTap: (){
                                                setState(() {
                                                       ...
                                                       nameList.contains(name) ?nameList.remove(name) :nameList.add(name);
                                                });
                                            },
                                             child: Container(
                                                    ...
                                                    // backgroundColor:const Color.fromRGBO(249, 246, 238, 1), 
                                                     child:  Stack(
                                                       children: [
                                                         ...
                                                         Center(child: AvatarProfileImage(url:frdsList[index]['avatar']?? userAvatar , width: 8, height: 18)),
