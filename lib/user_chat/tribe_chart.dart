      ...
      bottomNavigationBar:  BottomNavigations(data: sizeRoom?3:2),
       ...
       appBar: AppBar(
          ...
          actions: [
            ...
            Padding(
              ...
              child: InkWell(
                         ...
                         child: Icon(Icons.add_circle_outline,color:Colorcodes.black,size: 30,)
                        ),
            ),
          ...
          leading:  InkWell(
                       ...
                       child: Icon(Icons.arrow_back_sharp,color: Colorcodes.black,size: 30,)
                      ),
            title:  Text(("Tribe Chats"),
...
Widget getChatList(){
   return load.value?    Loader(): chatList.isEmpty?  Center(
                  child: Container(
                     width: MediaQuery.of(context).size.width/1.1,
                    
                     height: MediaQuery.of(context).size.height/2,
                    child: Center(child: Text(StringConstant.chatText,  style: FontManager().getTextStyle(context,
 ...
 Widget profileContainer(item) {
      ...
      // bool flag=chatOfUserList.containsKey(key);
              ...
              child: Container(
                ...
                child: Row(
                     children: [
                            ...
                            AvatarProfileImage(url: item['avatar']?? userAvatar, width: 8, height: 16),
                            const SizedBox(width: 4,),
                      
                          Container(
                             width: width>=500 ?width/2.2 : width>=300?width/2.5:width/3.1,
                        ...
                        child: Row(
                         ...
                         item['count']!=0 ?   Container(
                               ...
                               child: Center(child: Text( item['count'].toString(), style: FontManager().getTextStyle(context,
                                    lWeight: FontWeight.bold,
                                    fontSize: 14,
                                    color: Colorcodes.dropdown))),
                         ):SizedBox.shrink(),
            
                         chatOfUserList.containsKey(key) ? const SizedBox(
                             width: 3,
                        ):SizedBox.shrink(),
                            ...
                            InkWell(
                                onTap: (){
                                        ...
                                        //       context,
                                        //       MaterialPageRoute(
                                        //         builder: (context) => PollUser( id:item["_id"],myId: myId),
                                        //       ),
                                        //   );  
                                },
                                child: imageurl("assets/images/poll.svg")
                              ),
                           const SizedBox(
                              width: 3,
                            ),
