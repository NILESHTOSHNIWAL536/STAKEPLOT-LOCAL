module.exports = {
  ...
  SummaryRepository: require('./autoTransactions-repository/summary'),
  TransactionRepository: require('./autoTransactions-repository/transaction'),
  GetCustomDatesTransactions: require('./autoTransactions-repository/get-custom-transactions'),
};
