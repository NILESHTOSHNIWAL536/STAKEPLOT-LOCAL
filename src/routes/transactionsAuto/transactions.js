...
router.post("/grouped/:groupId/categorize", AuthMiddlewares.protect, validateRequestMiddleware(categorizeGroupedTransaction), TransactionAutoController.categorizeGroupedTransaction);
router.post("/verify-pending-transaction/:transactionId/:isCorrect", AuthMiddlewares.protect, validateRequestMiddleware(verifyPendingTransaction), TransactionAutoController.verifyPendingTransaction);
...
router.get("/getTransactions/:page/:search/:isBankAccount", AuthMiddlewares.protect, validateRequestMiddleware(getSearchedTransactions) ,TransactionAutoController.getSearchedTransactions);
router.get("/getTransactionsOfUser", AuthMiddlewares.protect, TransactionAutoController.getAllTransactionsOfUser);
router.get("/getTransactionsForAccount/:accountId/:page", AuthMiddlewares.protect, validateRequestMiddleware(getAllTransactionsForAccount), TransactionAutoController.getAllTransactionsForAccount);
...
router.get("/getAllCustomTransactions/:accountId/:type/:value", AuthMiddlewares.protect, validateRequestMiddleware(getAllCustomTransactions), TransactionAutoController.getAllCustomTransactions);
router.get("/getWholeTransactionsGraph/:type/:value", AuthMiddlewares.protect, validateRequestMiddleware(getWholeTransactionsGraph), TransactionAutoController.getWholeTransactionsGraph);
...
router.get("/get-monthly-transactions-history/:accountId/:type/:page", AuthMiddlewares.protect,validateRequestMiddleware(getMonthlyTransactionsHistory), TransactionAutoController.getMonthlyTransactionsHistory);
router.get("/get-previous-transactions/:date/:accountId", AuthMiddlewares.protect, validateRequestMiddleware(getPreviousTransactions),TransactionAutoController.getPreviousTransactions);
