...
import {
  ...
  validateScrape,
  validateProcessPendingStatement,
...
router.get('/pending-statements', validateNoQuery, EmailController.getPendingStatements);
router.post(
  '/process-pending-statement',
  validateProcessPendingStatement,
  EmailController.processPendingStatement
);
