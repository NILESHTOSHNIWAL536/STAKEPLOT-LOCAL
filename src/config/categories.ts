...
//     FoodItems: ['eats', 'Italia', 'milk'],
//   },

//   Shopping: {
//     Ecommerce: ['Amazon', 'Flipkart', 'Myntra', 'Nykaa', 'amznlpa', 'avenuesupermart', 'SHOPPERS P'],
...
//     PersonalCare: ['Salon', 'Spa', 'Laundry', 'Tailor', 'Haircare', 'Skincare'],
...
//     Dairy: ['milk', 'SUPRDAILY'],

//     OnlineGroceries: ['netmeds', '1mg', 'Bluedart', 'ekart', 'Delhivery', 'e cart', 'EKARTybl', 'paytm-delhivery', 'Shadowfax'],
//   },
...
//   Bills: {
//     Utilities: ['Electricity', 'Water', 'Gas', 'bpcl'],
...
//     FeesAndAdmissions: ['Fees', 'Fee', 'Admission', 'Examination', 'Exam fees', 'School Fees'],

//     BooksAndStationery: ['Books', 'Stationary', 'Uniform', 'STUDENT XEROX'],

//     ChildrenNeeds: ['miniklub', 'firstcry', 'TOY STORE', 'hamleys', 'Baby store', 'baby care'],
